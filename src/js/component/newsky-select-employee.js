...
class SelectEmployee extends LitElement {
    static properties = {
  ...
  `
    ...
    productSelected(event) {
        ...
        this.dispatchEvent(new CustomEvent('employee-select', { detail: this.selectedProduct }))
    }
...
window.customElements.define("newsky-select-employee", SelectEmployee)
